...
import { DashboardData, PeerSearchResult, COLORS } from '../lib/types';
...
export default function PeerValuationView({ data, state, dispatch }: PeerValuationViewProps) {
  ...
  const runValuation = useCallback(async () => {
    ...
    try {
      ...
      // Display error to user via alert for now
      const msg = err instanceof Error ? err.message : 'Peer valuation failed';
      alert(msg);
    } finally {
        ...
        <div className="space-y-4">
                ...
                >
                  ...
                  {peer.description && (
                    <p
                      ...
                      style={{ color: 'var(--t3)', fontSize: '8.5px', lineHeight: '1.2' }}
                    >
                      {peer.description}
                    </p>
                  )}
          ...
          {result.index_regressions.length > 0 && (
            ...
            >
              ...
              <div className="grid gap-3" style={{ gridTemplateColumns: 'repeat(auto-fill, minmax(280px, 1fr))' }}>
                {result.index_regressions.map((ir) => (
                  <div
                    key={ir.index_name}
                  ...
                  >
                    <div className="flex items-center gap-2 mb-2">
                      <span className="font-bold" style={{ fontSize: '12px', color: 'var(--t1)' }}>
                        {ir.index_name}
                      </span>
                      <span
                      ...
                      return (
                        <div key={reg.metric_type} className="mb-1.5">
                          <div className="flex items-center justify-between">
                            <span style={{ fontSize: '9.5px', color: 'var(--t2)' }}>
                              {reg.metric_label}
                            </span>
                          ...
                          <div
                            ...
                            style={{ fontSize: '8.5px', color: 'var(--t3)', fontFamily: "'JetBrains Mono', monospace" }}
                          >
          ...
          >
            <div
              ...
              style={{ fontSize: '9.5px', color: 'var(--t3)', letterSpacing: '1px' }}
            >
              Composite Valuation — {result.ticker}
            </div>
            <div className="grid gap-3" style={{ gridTemplateColumns: 'repeat(3, 1fr)' }}>
              {result.composite_valuation.map((cv) => {
                  ...
                  >
                    ...
                    {cv.weighted_implied_multiple !== null ? (
                      <>
                        ...
                        {cv.actual_multiple !== null && (
                          ...
                          >
                            ...
                            {cv.deviation_pct !== null && (
                              <span
                                style={{
                                  color: cv.deviation_pct > 0 ? '#ef4444' : '#10b981',
                                  marginLeft: '4px',
                                }}
                              >
                        ...
                        <span
                          className="block mt-0.5"
                          style={{ fontSize: '8px', color: 'var(--t3)' }}
                        >
                ...
                return (
                  ...
                  >
                    ...
                    <div
                      ...
                      style={{ fontFamily: "'JetBrains Mono', monospace", fontSize: '9px', color: 'var(--t2)' }}
                    >
